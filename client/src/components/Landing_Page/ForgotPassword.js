    ...
    <div className="w-screen h-screen flex justify-center items-center">
      <form className="w-72 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={onSubmit}>
        ...
        <div className="mb-6 flex items-center justify-between">
          <button className="bg-[#394D79] hover:bg-[#293757] text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" disabled={loading} type="submit">Reset Password</button>
        </div>
